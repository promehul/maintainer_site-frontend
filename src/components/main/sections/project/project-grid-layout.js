...
class AppBox extends Component {
    ...
    render() {
        ...
        const titleToColorMap = {
            ...
            'chakra': 'linear-gradient(133.04deg, rgba(69, 97, 138, 0.5) 0%, rgba(65, 87, 120, 0.5) 0.01%, rgba(139, 170, 215, 0.33) 100%)',
            'connect_e_dil': 'linear-gradient(133.04deg, rgba(255, 118, 134, 0.63) 0%, rgba(255, 144, 157, 0.66) 0.01%, rgba(255, 192, 201, 0.25) 100%)',
...
class GridLayout extends Component {
    constructor(props) {
        ...
        let gridsRemaining = Math.min(projectCount, BOX_COUNT - 2)
